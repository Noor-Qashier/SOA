  ...
  <div id="payInfo" class="row" style="display: ">
      <table class="table" width="100%" cellspacing="0">
        <thead>
          ...
          <input type="number" onclick="eraseMod()" value="'.$l_module.'" class="form-control text-right payModule" id="payModule" aria-describedby="emailHelp" placeholder="Amount"></td>
          </tr>
        </thead>
      </table>
  </div>
      ...
      <table class="table" width="100%" cellspacing="0">
        <thead>
          ...
          <input onclick="amount()" type="number" class="form-control text-right" id="or_no" placeholder="OR Number"></td>
            <td align=""><label for="Status">Amount</label>
          <input type="number" class="form-control text-right" value="'.$total_fees.'" id="amountPay" onclick="erasePay()" placeholder="Amount" ></td>
          <td align=""><label for="Status">Learning Module:</label>
          <input onclick="eraseMod()"  type="number" class="form-control text-right payModule" id="payModule" value="'.$l_module.'" aria-describedby="emailHelp" placeholder="Amount"></td>
          <input type="text" id="monthly" value="'.$monthly.'" hidden/>
          </tr>
        </thead>
      </table>

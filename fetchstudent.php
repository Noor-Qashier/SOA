...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
	  ...
	  <tbody>
	  	...
	  	<tr>
	  		<td>Tuition fee:</td>
	  		<td width="150" align="right">&#8369; '.number_format($row2["tuition_fees"],2).'</td>
	  	</tr>
	  	<tr>
	  		<td>Other School Fees:</td>
	  		<td width="150" align="right">&#8369; '.number_format($row2["other_school_fees"],2).'</td>
	  	</tr>
	  	<tr>
	  		<td>Lerning Module</td>
	  		<td width="150" align="right">&#8369; '.number_format($row2["learning_module"],2).'</td>
	  	</tr>
	  	<tr>
	  		<td align="right"><b>Total:</b></td>
	  		<td width="150" align="right"><b>&#8369; '.number_format($row2["subtotal"],2).'</b></td>
	  	</tr>
</div>
<div class="form-group">
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
	  ...
	  <tbody>
	  	<tr>
	  		<td>Tuition fee</td>
	  		<td width="150" align="right">&#8369; '.number_format($tuition_fee,2).'</td>
	  	</tr>
	  	<tr>
	  	...
	  	<tr>
	  		...
	  		<td width="150" align="right">&#8369; '.number_format($totalPay,2).'</td>
	  	</tr>
	  	<tr>
	  		<td align="right"><b>Ending Balance:</b></td>
	  		<td width="150" align="right"><b>&#8369; '.number_format($totalBalance,2).'</b></td>
	  	</tr>
</div>
